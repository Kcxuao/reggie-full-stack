<template>
    ...
    <div class="shopping_cart">
        <img :src="cartImage" alt="" @click="cartListRef.flag = true">
...
const cartImage = computed(() => {
    if (cartList.value.length) {
        return new URL('../../assets/images/cart_active.png', import.meta.url).href
    }

    return new URL('../../assets/images/cart.png', import.meta.url).href
})
